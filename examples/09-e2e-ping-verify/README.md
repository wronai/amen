...
Flow: **prompt → intent.yaml → intract.yaml (kontrakt) → service → walidacja**.
...
python ../_scripts/intent_to_intract.py generated/intent.yaml -o generated/intract.yaml -p prompt.txt
